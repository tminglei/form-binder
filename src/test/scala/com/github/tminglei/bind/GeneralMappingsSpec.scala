...
class GeneralMappingsSpec extends FunSpec with ShouldMatchers {
  ...
  describe("test pre-defined general usage mappings") {
    ...
    describe("list-simple") {
      ...
      it("null data") {
        val nullData = Map[String, String]()
        list.validate("number", nullData, dummyMessages, Options.apply()) match {
          case Nil => {
            base.validate("number[0]", nullData, dummyMessages, Options.apply()) should be (Nil)
      ...
      it("empty data") {
        ...
        list.validate("number", emptyData, dummyMessages, Options.apply()) match {
          case Nil => {
    ...
    describe("map-simple") {
      ...
      it("null data") {
        val nullData = Map[String, String]()
        map.validate("map", nullData, dummyMessages, Options.apply()) match {
          case Nil => {
            base.validate("map.aa", nullData, dummyMessages, Options.apply()) should be (Nil)
      ...
      it("empty data") {
        ...
        map.validate("map", emptyData, dummyMessages, Options.apply()) match {
          case Nil => {
    ...
    describe("optional-compound") {
      ...
      it("null data") {
        ...
        optional.validate("test", nullData, dummyMessages1, Options.apply()) match {
          case Nil => {
            base.validate("test", nullData, dummyMessages1, Options.apply()) should be (Seq("test" -> "test missing or not valid"))
      ...
      it("empty data (wrong way)") {
        ...
        optional.validate("test", emptyData, dummyMessages1, Options.apply()) match {
          case Nil => {
            base.validate("test", emptyData, dummyMessages1, Options.apply()) should be (Seq("test" -> "test missing or not valid"))
    ...
    describe("list-compound") {
      ...
      it("null data") {
        ...
        list.validate("test", nullData, dummyMessages1, Options.apply()) match {
          case Nil => {
            base.validate("test[0]", nullData, dummyMessages1, Options.apply()) should be (Seq("test[0]" -> "test[0] missing or not valid"))
      ...
      it("empty data (wrong way)") {
        ...
        list.validate("test", emptyData, dummyMessages1, Options.apply()) match {
          case Nil => {
            base.validate("test[0]", emptyData, dummyMessages1, Options.apply()) should be (Seq("test[0]" -> "test[0] missing or not valid"))
    ...
    describe("map-compound") {
      ...
      it("null data") {
        ...
        map.validate("test", nullData, dummyMessages1, Options.apply()) match {
          case Nil => {
            value.validate("test.101", nullData, dummyMessages1, Options.apply()) should be (Seq("test.101" -> "test.101 missing or not valid"))
