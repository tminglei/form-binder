...
trait Bindings {
  ...
  def text(constraints: Constraint*): FieldBinding[String] = new FieldBinding[String](constraints) {
    override def convert(value: String): String = value
  }

  def boolean(constraints: Constraint*): FieldBinding[Boolean] =
    new FieldBinding[Boolean](parsing(_.toBoolean, "error.boolean") +: constraints) {
  ...
  def number(constraints: Constraint*): FieldBinding[Int] =
    new FieldBinding[Int](parsing(_.toInt, "error.number") +: constraints) {
  ...
  def double(constraints: Constraint*): FieldBinding[Double] =
    new FieldBinding[Double](parsing(_.toDouble, "error.double") +: constraints) {
  ...
  def float(constraints: Constraint*): FieldBinding[Float] =
    new FieldBinding[Float](parsing(_.toFloat, "error.float") +: constraints) {
  ...
  def long(constraints: Constraint*): FieldBinding[Long] =
    new FieldBinding[Long](parsing(_.toLong, "error.long") +: constraints) {
  ...
  def bigDecimal(constraints: Constraint*): FieldBinding[BigDecimal] =
    new FieldBinding[BigDecimal](parsing(BigDecimal.apply, "error.bigdecimal") +: constraints) {
  ...
  def bigInt(constraints: Constraint*): FieldBinding[BigInt] =
    new FieldBinding[BigInt](parsing(BigInt.apply, "error.bigint") +: constraints) {
  ...
  def date(pattern: String, constraints: Constraint*): FieldBinding[java.util.Date] = {
    ...
    new FieldBinding[java.util.Date](parsing(dateFormatter.parse, "error.pattern", pattern) +: constraints) {
  ...
  //////////////////////////////////////////////  general usage bindings  //////////////////////////////////////

  def ignored[T](instead: T): Binding[T] = new Binding[T]() {
    override def convert(name: String, params: Map[String, String]): T = instead
  ...
  def map[V](valueBinding: Binding[V]): Binding[Map[String, V]] = map(text(), valueBinding)

  def map[K, V](keyBinding: FieldBinding[K], valueBinding: Binding[V]): Binding[Map[K, V]] = new Binding[Map[K, V]] {
    override def convert(name: String, params: Map[String, String]): Map[K, V] =
      Map.empty ++ keys(name, params).map { key =>
        val pureKey = key.replaceAll("^\"", "").replaceAll("\"$", "")
        (keyBinding.convert(pureKey), valueBinding.convert(name + "." + key, params))
      }

    override def validate(name: String, params: Map[String, String], messages: Messages): Seq[(String, String)] =
      keys(name, params).map { key =>
        val pureKey = key.replaceAll("^\"", "").replaceAll("\"$", "")
        keyBinding.validate(name + "." + key + "_key", pureKey, messages) ++
          valueBinding.validate(name + "." + key, params, messages)
      }.flatten
  ...
  ////////////////////////////////////////////  pre-defined group bindings  ///////////////////////////////////

  // tuple version
  def binding[P1](f1: (String, Binding[P1])) = binding[(P1), P1](f1)(identity)
  // normal version
  def binding[T, P1](f1: (String, Binding[P1]))(factory: (P1) => T): GroupBinding[T] = new GroupBinding[T] {
    def fields = Seq(f1)
  ...
  // normal version
  def binding[T, P1, P2](f1: (String, Binding[P1]), f2: (String, Binding[P2]))(factory: (P1, P2) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]))(factory: (P1, P2, P3) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]))(factory: (P1, P2, P3, P4) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]))(factory: (P1, P2, P3, P4, P5) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]))(factory: (P1, P2, P3, P4, P5, P6) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]))(factory: (P1, P2, P3, P4, P5, P6, P7) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]), f11: (String, Binding[P11]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]), f11: (String, Binding[P11]), f12: (String, Binding[P12]), f13: (String, Binding[P13]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]), f11: (String, Binding[P11]), f12: (String, Binding[P12]), f13: (String, Binding[P13]), f14: (String, Binding[P14]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]), f11: (String, Binding[P11]), f12: (String, Binding[P12]), f13: (String, Binding[P13]), f14: (String, Binding[P14]), f15: (String, Binding[P15]), f16: (String, Binding[P16]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]), f11: (String, Binding[P11]), f12: (String, Binding[P12]), f13: (String, Binding[P13]), f14: (String, Binding[P14]), f15: (String, Binding[P15]), f16: (String, Binding[P16]), f17: (String, Binding[P17]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]), f11: (String, Binding[P11]), f12: (String, Binding[P12]), f13: (String, Binding[P13]), f14: (String, Binding[P14]), f15: (String, Binding[P15]), f16: (String, Binding[P16]), f17: (String, Binding[P17]), f18: (String, Binding[P18]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]), f11: (String, Binding[P11]), f12: (String, Binding[P12]), f13: (String, Binding[P13]), f14: (String, Binding[P14]), f15: (String, Binding[P15]), f16: (String, Binding[P16]), f17: (String, Binding[P17]), f18: (String, Binding[P18]), f19: (String, Binding[P19]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]), f11: (String, Binding[P11]), f12: (String, Binding[P12]), f13: (String, Binding[P13]), f14: (String, Binding[P14]), f15: (String, Binding[P15]), f16: (String, Binding[P16]), f17: (String, Binding[P17]), f18: (String, Binding[P18]), f19: (String, Binding[P19]), f20: (String, Binding[P20]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20) => T): GroupBinding[T] = new GroupBinding[T] {
  ...
  // normal version
  def binding[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21](f1: (String, Binding[P1]), f2: (String, Binding[P2]), f3: (String, Binding[P3]), f4: (String, Binding[P4]), f5: (String, Binding[P5]), f6: (String, Binding[P6]), f7: (String, Binding[P7]), f8: (String, Binding[P8]), f9: (String, Binding[P9]), f10: (String, Binding[P10]), f11: (String, Binding[P11]), f12: (String, Binding[P12]), f13: (String, Binding[P13]), f14: (String, Binding[P14]), f15: (String, Binding[P15]), f16: (String, Binding[P16]), f17: (String, Binding[P17]), f18: (String, Binding[P18]), f19: (String, Binding[P19]), f20: (String, Binding[P20]), f21: (String, Binding[P21]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21) => T): GroupBinding[T] = new GroupBinding[T] {
